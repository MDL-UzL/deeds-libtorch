...
int main (int argc, char * const argv[]) {
    ...
    float* img2; // only difference to apply BCV
    ...
    float* warped=new float[sz]; // onlydifference to applyBCV
    //
    ...
    //
    gzWriteNifti(args.deformed_file,warped,header,m,n,o,1); //difference to applyBCV
